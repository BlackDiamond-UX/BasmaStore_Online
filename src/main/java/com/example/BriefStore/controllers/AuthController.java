...
import com.example.BriefStore.request.LoginRequest;
...
import com.example.BriefStore.security.jwt.JwtUtils;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		boolean verification = userRepository.findByEmail(loginRequest.getEmail()).getEmailVerificationStatus();
		if (verification == true) {
			...
			return ResponseEntity.ok(new MessageResponse("Please Validate Your Account"));
	}
